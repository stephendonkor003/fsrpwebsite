...
@section('content')
    <article>
        ...
        <div class="container article-image-wrap"><img src="{{ $post->image ?: asset('images/seed-investment-summit/seed-investment-summit-2026.jpeg') }}" alt=""></div>
