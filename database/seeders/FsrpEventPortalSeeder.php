...
class FsrpEventPortalSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $settings = [
            ...
            'copyright' => $this->t('FSRP Events · Food system resilience', 'Ã‰vÃ©nements FSRP · RÃ©silience des systÃ¨mes alimentaires', 'ÙØ¹Ø§Ù„ÙŠØ§Øª FSRP · ØµÙ…ÙˆØ¯ Ø§Ù„Ù†Ø¸Ù… Ø§Ù„ØºØ°Ø§Ø¦ÙŠØ©', 'Eventos FSRP · ResiliÃªncia dos sistemas alimentares', 'Eventos FSRP · Resiliencia de los sistemas alimentarios', 'Matukio ya FSRP · Ustahimilivu wa mifumo ya chakula'),
            'address' => $this->t(''),
        ];
    ...
    private function seedFaqs(): void
    {
        $faqs = [
            ...
            [
                ...
                $this->t('This partner event is convened by the African Union Commission (AUC), with Member States, regional economic communities, technical institutions and development partners. It is not presented here as an FSRP-convened event.', 'Cet Ã©vÃ©nement partenaire est organisÃ© par la Commission de lâ€™Union africaine (CUA), avec les Ã‰tats membres, les communautÃ©s Ã©conomiques rÃ©gionales, les institutions techniques et les partenaires de dÃ©veloppement.', 'ØªÙ†Ø¸Ù… Ù‡Ø°Ù‡ Ø§Ù„ÙØ¹Ø§Ù„ÙŠØ© Ø§Ù„Ø´Ø±ÙŠÙƒØ© Ù…ÙÙˆØ¶ÙŠØ© Ø§Ù„Ø§ØªØ­Ø§Ø¯ Ø§Ù„Ø¥ÙØ±ÙŠÙ‚ÙŠ ØŒ Ù…Ø¹ Ø§Ù„Ø¯ÙˆÙ„ Ø§Ù„Ø£Ø¹Ø¶Ø§Ø¡ ÙˆØ§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø§Øª Ø§Ù„Ø§Ù‚ØªØµØ§Ø¯ÙŠØ© Ø§Ù„Ø¥Ù‚Ù„ÙŠÙ…ÙŠØ© ÙˆØ§Ù„Ù…Ø¤Ø³Ø³Ø§Øª Ø§Ù„ÙÙ†ÙŠØ© ÙˆØ´Ø±ÙƒØ§Ø¡ Ø§Ù„ØªÙ†Ù…ÙŠØ©.', 'Este evento de parceiros Ã© organizado pela ComissÃ£o da UniÃ£o Africana, com Estados-Membros, comunidades econÃ³micas regionais, instituiÃ§Ãµes tÃ©cnicas e parceiros de desenvolvimento.', 'Este evento de socios es convocado por la ComisiÃ³n de la UniÃ³n Africana, con los Estados miembros, comunidades econÃ³micas regionales, instituciones tÃ©cnicas y socios de desarrollo.', 'Tukio hili la washirika linaandaliwa na Tume ya Umoja wa Afrika, pamoja na nchi wanachama, jumuiya za kiuchumi za kikanda, taasisi za kiufundi na washirika wa maendeleo.'),
            ],
            [
        ...
        $this->updateEnglishFaqAnswer(
            ...
            '15–18 September 2026 at Rainbow Towers Hotel and Conference Centre, Pennefather Avenue, Samora Machel Avenue, Harare, Zimbabwe. Daily session times remain subject to confirmation by the conveners.',
        );
        $this->updateEnglishFaqAnswer(
    ...
    private function seedPartnerEvent(): Event
    {
        $event = Event::query()->updateOrCreate(['slug' => self::EVENT_SLUG], [
            ...
            'excerpt' => $this->t('Partner event · African Union Commission (AUC) · From the CAADP Strategy and Action Plan 2026–2035 to practical country and regional delivery.', 'Ã‰vÃ©nement partenaire · CUA · De la stratÃ©gie et du plan dâ€™action du PDDAA 2026–2035 Ã  une mise en Å“uvre concrÃ¨te aux niveaux national et rÃ©gional.', 'ÙØ¹Ø§Ù„ÙŠØ© Ø´Ø±ÙŠÙƒØ© · Ù…ÙÙˆØ¶ÙŠØ© Ø§Ù„Ø§ØªØ­Ø§Ø¯ Ø§Ù„Ø¥ÙØ±ÙŠÙ‚ÙŠ · Ù…Ù† Ø§Ø³ØªØ±Ø§ØªÙŠØ¬ÙŠØ© ÙˆØ®Ø·Ø© Ø¹Ù…Ù„ CAADP Ù„Ù„ÙØªØ±Ø© 2026–2035 Ø¥Ù„Ù‰ Ø§Ù„ØªÙ†ÙÙŠØ° Ø§Ù„Ø¹Ù…Ù„ÙŠ Ø§Ù„Ù‚Ø·Ø±ÙŠ ÙˆØ§Ù„Ø¥Ù‚Ù„ÙŠÙ…ÙŠ.', 'Evento parceiro · CUA · Da EstratÃ©gia e Plano de AÃ§Ã£o CAADP 2026–2035 Ã  implementaÃ§Ã£o prÃ¡tica nacional e regional.', 'Evento de socios · CUA · De la Estrategia y Plan de AcciÃ³n CAADP 2026–2035 a la ejecuciÃ³n prÃ¡ctica nacional y regional.', 'Tukio la washirika · AUC · Kutoka Mkakati na Mpango wa Utekelezaji wa CAADP 2026–2035 hadi utekelezaji wa vitendo wa nchi na kanda.'),
            'body' => $this->t(
                ...
                'ÙØ¹Ø§Ù„ÙŠØ© Ø´Ø±ÙŠÙƒØ©. ØªÙ†Ø¸Ù…Ù‡Ø§ Ù…ÙÙˆØ¶ÙŠØ© Ø§Ù„Ø§ØªØ­Ø§Ø¯ Ø§Ù„Ø¥ÙØ±ÙŠÙ‚ÙŠ  Ù…Ø¹ Ø§Ù„Ø¯ÙˆÙ„ Ø§Ù„Ø£Ø¹Ø¶Ø§Ø¡ ÙˆØ§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø§Øª Ø§Ù„Ø§Ù‚ØªØµØ§Ø¯ÙŠØ© Ø§Ù„Ø¥Ù‚Ù„ÙŠÙ…ÙŠØ© ÙˆØ§Ù„Ù…Ø¤Ø³Ø³Ø§Øª Ø§Ù„ÙÙ†ÙŠØ© ÙˆØ´Ø±ÙƒØ§Ø¡ Ø§Ù„ØªÙ†Ù…ÙŠØ©. ØªØ±Ø¨Ø· Ø§Ù„Ø£ÙŠØ§Ù… Ø§Ù„Ø£Ø±Ø¨Ø¹Ø© Ø§Ù„ØªÙˆØ¬ÙŠÙ‡ Ø§Ù„Ø³ÙŠØ§Ø³ÙŠ ÙˆØ§Ù„Ø¬Ø§Ù‡Ø²ÙŠØ© Ø§Ù„Ù‚Ø·Ø±ÙŠØ© ÙˆØ§Ù„Ø¥Ù‚Ù„ÙŠÙ…ÙŠØ© ÙˆÙ…Ø®ØªØ¨Ø±Ø§Øª Ø§Ù„ØªÙ†ÙÙŠØ° ÙˆÙ…ÙˆØ§Ø¡Ù…Ø© Ø§Ù„Ø§Ø³ØªØ«Ù…Ø§Ø± ÙˆØ§Ù„Ù…Ø³Ø§Ø¡Ù„Ø© Ø§Ù„Ù…ØªØ¨Ø§Ø¯Ù„Ø©. Ø§Ù„ØªØ±Ø¬Ù…Ø© Ø§Ù„ÙÙˆØ±ÙŠØ© Ù…Ø¯Ø±Ø¬Ø© Ø¨Ø§Ù„Ø¹Ø±Ø¨ÙŠØ© ÙˆØ§Ù„Ø¥Ù†Ø¬Ù„ÙŠØ²ÙŠØ© ÙˆØ§Ù„ÙØ±Ù†Ø³ÙŠØ© ÙˆØ§Ù„Ø¨Ø±ØªØºØ§Ù„ÙŠØ©. ÙŠØ¤ÙƒØ¯ Ø§Ù„Ù…ÙˆØ¬Ø² Ù‡Ø±Ø§Ø±ÙŠØŒ Ø²ÙŠÙ…Ø¨Ø§Ø¨ÙˆÙŠØŒ Ù…Ù† 15 Ø¥Ù„Ù‰ 18 Ø³Ø¨ØªÙ…Ø¨Ø± 2026Ø› ÙˆÙŠØ¬Ø¨ Ø£Ù† ÙŠØ¤ÙƒØ¯ Ø§Ù„Ù…Ù†Ø¸Ù…ÙˆÙ† Ù…ÙˆØ§Ø¹ÙŠØ¯ Ø§Ù„Ø¬Ù„Ø³Ø§Øª ÙˆØ§Ù„Ù…ÙƒØ§Ù† Ø§Ù„Ø¯Ù‚ÙŠÙ‚ ÙˆØªØ±ØªÙŠØ¨Ø§Øª Ø§Ù„Ù…Ø´Ø§Ø±ÙƒØ©. Ù†Ø²Ù‘Ù„ Ø§Ù„Ù…ÙˆØ¬Ø² Ø§Ù„Ø£ØµÙ„ÙŠ ÙˆÙ†Ø¸Ø±Ø© Ø¹Ø§Ù…Ø© Ø¹Ù„Ù‰ Ø§Ù„Ø¨Ø±Ù†Ø§Ù…Ø¬.',
                'EVENTO PARCEIRO. Organizado pela ComissÃ£o da UniÃ£o Africana com Estados-Membros, comunidades econÃ³micas regionais, instituiÃ§Ãµes tÃ©cnicas e parceiros de desenvolvimento. Os quatro dias ligam orientaÃ§Ã£o polÃ­tica, preparaÃ§Ã£o nacional e regional, laboratÃ³rios de implementaÃ§Ã£o, investimento e responsabilizaÃ§Ã£o mÃºtua. EstÃ¡ indicada interpretaÃ§Ã£o em Ã¡rabe, inglÃªs, francÃªs e portuguÃªs. A nota confirma Harare, ZimbabuÃ©, de 15 a 18 de setembro de 2026; os organizadores devem confirmar horÃ¡rios, local especÃ­fico e participaÃ§Ã£o. Descarregue a nota original e a visÃ£o geral do programa.',
                'EVENTO DE SOCIOS. Convocado por la ComisiÃ³n de la UniÃ³n Africana con Estados miembros, comunidades econÃ³micas regionales, instituciones tÃ©cnicas y socios de desarrollo. Los cuatro dÃ­as conectan orientaciÃ³n polÃ­tica, preparaciÃ³n nacional y regional, laboratorios de ejecuciÃ³n, inversiÃ³n y rendiciÃ³n de cuentas mutua. Se indica interpretaciÃ³n en Ã¡rabe, inglÃ©s, francÃ©s y portuguÃ©s. La nota confirma Harare, Zimbabue, del 15 al 18 de septiembre de 2026; los organizadores deben confirmar horarios, lugar especÃ­fico y participaciÃ³n. Descargue la nota original y el resumen del programa.',
                'TUKIO LA WASHIRIKA. Linaandaliwa na Tume ya Umoja wa Afrika pamoja na nchi wanachama, jumuiya za kiuchumi za kikanda, taasisi za kiufundi na washirika wa maendeleo. Siku nne zinaunganisha mwelekeo wa kisiasa, utayari wa nchi na kanda, maabara za utekelezaji, uwekezaji na uwajibikaji wa pamoja. Ukalimani umeorodheshwa kwa Kiarabu, Kiingereza, Kifaransa na Kireno. Muhtasari unathibitisha Harare, Zimbabwe, tarehe 15–18 Septemba 2026; waandaaji wanapaswa kuthibitisha saa, ukumbi maalumu na ushiriki. Pakua waraka asili na muhtasari wa programu.',
            ),
        ...
        $excerpt['en'] = 'Partner event | African Union Commission (AUC) | From the CAADP Strategy and Action Plan 2026-2035 to practical country and regional delivery.';
        $body = $event->body;
    ...
    private function seedDailyOverview(Event $event): void
    {
        $days = [
            [
                'date' => '2026-09-15',
                'title' => $this->t('Day 1 · Political direction & CAADP strategy', 'Jour 1 · Orientation politique et stratÃ©gie PDDAA', 'Ø§Ù„ÙŠÙˆÙ… Ø§Ù„Ø£ÙˆÙ„ · Ø§Ù„ØªÙˆØ¬ÙŠÙ‡ Ø§Ù„Ø³ÙŠØ§Ø³ÙŠ ÙˆØ§Ø³ØªØ±Ø§ØªÙŠØ¬ÙŠØ© CAADP', 'Dia 1 · OrientaÃ§Ã£o polÃ­tica e estratÃ©gia CAADP', 'DÃ­a 1 · OrientaciÃ³n polÃ­tica y estrategia CAADP', 'Siku ya 1 · Mwelekeo wa kisiasa na mkakati wa CAADP'),
                'summary' => $this->t(
            ...
            [
                'date' => '2026-09-16',
                'title' => $this->t('Day 2 · Country readiness & REC delivery', 'Jour 2 · PrÃ©paration nationale et mise en Å“uvre des CER', 'Ø§Ù„ÙŠÙˆÙ… Ø§Ù„Ø«Ø§Ù†ÙŠ · Ø¬Ø§Ù‡Ø²ÙŠØ© Ø§Ù„Ø¨Ù„Ø¯Ø§Ù† ÙˆØ§Ù„ØªÙ†ÙÙŠØ° Ø§Ù„Ø¥Ù‚Ù„ÙŠÙ…ÙŠ', 'Dia 2 · PreparaÃ§Ã£o nacional e implementaÃ§Ã£o das CER', 'DÃ­a 2 · PreparaciÃ³n nacional y ejecuciÃ³n de las CER', 'Siku ya 2 · Utayari wa nchi na utekelezaji wa kanda'),
                'summary' => $this->t(
                    'Identify what is ready, blocked and needed. Member States identify 1–3 priority actions; RECs identify cross-border and regional priorities. A partner session matches needs to solutions. Daily overview; session times to be confirmed.',
            ...
            [
                'date' => '2026-09-17',
                'title' => $this->t('Day 3 · Implementation delivery labs', 'Jour 3 · Laboratoires de mise en Å“uvre', 'Ø§Ù„ÙŠÙˆÙ… Ø§Ù„Ø«Ø§Ù„Ø« · Ù…Ø®ØªØ¨Ø±Ø§Øª Ø§Ù„ØªÙ†ÙÙŠØ°', 'Dia 3 · LaboratÃ³rios de implementaÃ§Ã£o', 'DÃ­a 3 · Laboratorios de ejecuciÃ³n', 'Siku ya 3 · Maabara za utekelezaji'),
                'summary' => $this->t(
            ...
            [
                'date' => '2026-09-18',
                'title' => $this->t('Day 4 · Investment, accountability & follow-up', 'Jour 4 · Investissement, redevabilitÃ© et suivi', 'Ø§Ù„ÙŠÙˆÙ… Ø§Ù„Ø±Ø§Ø¨Ø¹ · Ø§Ù„Ø§Ø³ØªØ«Ù…Ø§Ø± ÙˆØ§Ù„Ù…Ø³Ø§Ø¡Ù„Ø© ÙˆØ§Ù„Ù…ØªØ§Ø¨Ø¹Ø©', 'Dia 4 · Investimento, responsabilizaÃ§Ã£o e acompanhamento', 'DÃ­a 4 · InversiÃ³n, rendiciÃ³n de cuentas y seguimiento', 'Siku ya 4 · Uwekezaji, uwajibikaji na ufuatiliaji'),
                'summary' => $this->t(
        ...
        $resources = [
            ...
            [
                ...
                'description' => $this->t(
                    ...
                    'Document Word original fourni en anglais pour la 22e Plateforme de partenariat du PDDAA. Organisateurs : CUA.',
                    'ÙˆØ«ÙŠÙ‚Ø© Word Ø§Ù„Ø£ØµÙ„ÙŠØ© Ø§Ù„Ù…Ù‚Ø¯Ù…Ø© Ø¨Ø§Ù„Ø¥Ù†Ø¬Ù„ÙŠØ²ÙŠØ© Ù„Ù…Ù†ØµØ© Ø´Ø±Ø§ÙƒØ© CAADP Ø§Ù„Ø«Ø§Ù†ÙŠØ© ÙˆØ§Ù„Ø¹Ø´Ø±ÙŠÙ†. Ø§Ù„Ù…Ù†Ø¸Ù…: Ù…ÙÙˆØ¶ÙŠØ© Ø§Ù„Ø§ØªØ­Ø§Ø¯ Ø§Ù„Ø¥ÙØ±ÙŠÙ‚ÙŠ .',
                    'Documento Word original fornecido em inglÃªs para a 22.Âª Plataforma de Parceria CAADP. Organizadores: CUA.',
                    'Documento Word original facilitado en inglÃ©s para la 22.Âª Plataforma de AsociaciÃ³n CAADP. Organizadores: CUA.',
                    'Waraka asili wa Word uliotolewa kwa Kiingereza kwa Jukwaa la 22 la Ushirikiano wa CAADP. Waandaaji: Tume ya Umoja wa Afrika.',
                ),
                'category' => 'brief',
